...
data Statement
  =  ReturnStmt Expression  -- I did this to return just an expression of any kind, so the user could use return for many purposes -- TODO Remove this after adding legit data constructors
  deriving (Show)
